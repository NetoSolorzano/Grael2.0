        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (modo == "NUEVO")
            {
                ...
                if (conn.State == ConnectionState.Open)
                {
                    ...
                    mycomand.Parameters.AddWithValue("@dipw", Grael2.Program.vg_ipwan);
            ...
            if (modo == "EDITAR")
            {
                ...
                if (conn.State == ConnectionState.Open)
                {
                    ...
                    mycom.Parameters.AddWithValue("@dipw", Grael2.Program.vg_ipwan);
